...
public partial class EnvanterSistemiContext : DbContext
{
    public EnvanterSistemiContext()
    {
    }

    public EnvanterSistemiContext(DbContextOptions<EnvanterSistemiContext> options)
        : base(options)
    {
    }
